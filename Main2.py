...
def main():
    ...
    # Halaman Prediksi Kelayakan Air
        ...
        if uploaded_file:
            ...
            # Pelatihan model (menggunakan Logistic Regression sebagai contoh)
            ...
            # Menyimpan scaler dan model
            joblib.dump(scaler, 'scaler.pkl')
            joblib.dump(model, 'model.pkl')
            st.write("Model dan Scaler telah dilatih dan disimpan.")
            ...
            if st.button("Prediksi"):
                # Membaca model dan scaler yang sudah dilatih
